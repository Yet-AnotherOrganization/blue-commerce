...
import { askGenericModal } from '@/redux/slices/uiSlice.ts'
...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <div style={{ 'zIndex': '40', 'right': `${sidebar ? '0' : '-60vw'}` }} className={`fixed top-0 pt-[10vh] bg-blue-500 text-white inline-block w-[60vw] lg:w-[15vw] h-[100vh] transition-all p-4`} >
                ...
                <ul className='flex gap-6 flex-col'>
                    ...
                    <button onClick={()=>dispatch(askGenericModal({text: 'Are you sure you want to archive this product?', title:'Archive Product'}))}>
                        TEST MODAL
                    </button>
                </ul>
            </div>
